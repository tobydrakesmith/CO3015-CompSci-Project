...
import com.classfiles.theatreticketsapp.Review;
import com.classfiles.theatreticketsapp.Show;
import com.configfiles.theatreticketsapp.DatabaseAPI;

import com.recyclerviewadapters.theatreticketsapp.ReviewsRecyclerViewAdapter;
                ...
                dialog.setPositiveButton("Apply", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (selectedRadioButton != -1) {
                            ...
                            Toast.makeText(ViewReviews.this, "Select a rating", Toast.LENGTH_SHORT).show();
                    }
                });
