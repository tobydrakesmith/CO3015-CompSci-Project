...
public class MyPastBookingsRecyclerViewAdapter extends RecyclerView.Adapter<MyPastBookingsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPastBookingsRecyclerViewAdapter(Context context, MyPastBookingsRecyclerViewAdapter.OnReviewClickListener onClickListener, ArrayList<Booking> bookings) {
