...
public class ShowRecyclerViewAdapter extends RecyclerView.Adapter<ShowRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public ShowRecyclerViewAdapter(Context context, ArrayList<Show> shows, OnShowClickListener onShowClickListener, Location userLocation) {
    ...
    public void setFullList(ArrayList<Show> filteredShows) {
        showListFull.clear();
