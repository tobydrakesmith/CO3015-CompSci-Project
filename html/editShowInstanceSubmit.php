<?php
	...
	$stmt = $con->prepare("UPDATE showInstance SET startDate = ?, endDate = ?, bandAPrices = ?, bandBPrices = ?, bandCPrices = ?, bandDPrices = ?, bandANumTickets= ?, bandBNumTickets= ?,bandCNumTickets= ?, bandDNumTickets= ?, mondayMat= ?, mondayEve= ?, tuesdayMat= ?, tuesdayEve= ?, wednesdayMat= ?, wednesdayEve= ?, thursdayMat= ?, thursdayEve= ?, fridayMat= ?, fridayEve= ?, saturdayMat= ?, saturdayEve= ?, sundayMat= ?, sundayEve = ?, matineeTime = ?, eveningTime = ? WHERE venueName = ? AND showName = ?");
	$stmt->bind_param("ssiiiiiiiiiiiiiiiiiiiiiissss", $startdate, $enddate, $bandaprices, $bandbprices, $bandcprices, $banddprices, $bandanumseats, $bandbnumseats, $bandcnumseats, $banddnumseats, $mondaymat, $mondayeve, $tuesdaymat, $tuesdayeve, $wednesdaymat, $wednesdayeve, $thursdaymat, $thursdayeve, $fridaymat, $fridayeve, $saturdaymat, $saturdayeve, $sundaymat, $sundayeve, $matineestart, $eveningstart, $venuename, $showname);
	if ($stmt->execute()) echo 'true';
